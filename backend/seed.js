...
const seniorsData = [
  ...
  { name: 'רן רינת',         address: 'שמואל הנביא 72 פינת תדהר', phones: ['052-7152108'],                       morningTransport: t('שמואל הנביא מא"ש גאולה - בוקר'), afternoonTransport: t('מקור ברוך גאולה שמואל הנביא - צהריים'), days: DAYS_ABCDE },
  { name: 'אברמוב בתיה',     address: 'משה זקס 11',               phones: ['051-2051275'],                       morningTransport: t('שמואל הנביא מא"ש גאולה - בוקר'), afternoonTransport: t('מקור ברוך גאולה שמואל הנביא - צהריים'), days: DAYS_ABCDE },
  { name: 'רבקה קלירס',      address: 'סלנט פינת הרקח',           phones: ['054-8471280'],                       morningTransport: t('שמואל הנביא מא"ש גאולה - בוקר'), afternoonTransport: t('מקור ברוך גאולה שמואל הנביא - צהריים'), days: DAYS_ACE },
  ...
  { name: 'טרכטינגוט אריה',  address: 'בר גיורא 10',              phones: ['052-7624075'],                       morningTransport: t('שמואל הנביא מא"ש גאולה - בוקר'), afternoonTransport: t('מקור ברוך גאולה שמואל הנביא - צהריים'), days: DAYS_ABCDE },
  { name: 'שמואל הבלין',     address: 'יוסף בן מתיתיהו פינת אלפנדרי', phones: ['052-3911367', '058-6703369', '058-4413971'],  morningTransport: t('שמואל הנביא מא"ש גאולה - בוקר'), afternoonTransport: t('מקור ברוך גאולה שמואל הנביא - צהריים'), days: DAYS_ABCDE },
  { name: 'ציפורה בורנשטיין', address: 'יוסף בן מתיתיהו פינת פרי חדש', phones: ['054-8470354', '053-3114986'], morningTransport: t('שמואל הנביא מא"ש גאולה - בוקר'), afternoonTransport: t('מקור ברוך גאולה שמואל הנביא - צהריים'), days: DAYS_ABCDE },
  { name: 'אברהם שולמית',    address: 'יוסף בן מתיתיהו 20',       phones: ['054-8441964'],                       morningTransport: t('שמואל הנביא מא"ש גאולה - בוקר'), afternoonTransport: t('מקור ברוך גאולה שמואל הנביא - צהריים'), days: DAYS_ABCDE },
  { name: 'אסרף גינה',       address: 'ישעיהו 14',                phones: ['050-4143289'],                       morningTransport: t('שמואל הנביא מא"ש גאולה - בוקר'), afternoonTransport: t('מקור ברוך גאולה שמואל הנביא - צהריים'), days: DAYS_ABCDE },
